...
public class Pig extends Animal1 {
    ...
    public static void main(String[] args) {
        ...
        pig1.sleep();   //Pig is sleeping
        pig1.eat();     //Animal is eating
        ...
        if( myPig.equals(checkPig)) {
            System.out.println("same");    //before override, because equal() implementation from Object.class
        }                                  //in java really 2 objects
                                           //check 特徵
                                           //in java world memory object 有2個, 現實世界得一隻, 想 check 2隻是否一樣
        else {
            System.out.println("not same");//before override equal(), java 睇係 2 objects
        }
        ...
        System.out.println(s.equals(s2));//true, no need override, bocz string 作者認定佢地係一樣
